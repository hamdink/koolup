                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="600" style="background-color: #ffffff; border-radius: 4px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                            ...
                            <tr>
                                <td align="center" style="padding: 0 30px 30px 30px;">
                                    <a href="${BUTTON_LINK}" style="background-color: #007bff; border-radius: 25px; color: #ffffff; display: inline-block; font-size: 14px; line-height: 44px; text-align: center; text-decoration: none; width: 200px;">Reset Password</a>
                                </td>
                            </tr>
                        </table>
                    </td>
